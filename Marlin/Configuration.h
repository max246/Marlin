...
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 81.76, 80.08, 400, 105 } // mk8
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 81.76, 80.08, 400, 397 }
#else                                   // M8 threaded rod version
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 78.74, 78.74, 2560, 397 }
#endif
...
/**
   ...
   Override with M201
                                        X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
*/
#define DEFAULT_MAX_ACCELERATION      { 600, 600, 600, 5000 }
...
*/
#define DEFAULT_ACCELERATION          600//1250    // X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION  600//1250    // E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION   600//3000    // X, Y, Z acceleration for travel (non printing) moves
...
/**
   ...
   Some examples:
     ...
     T |       3   | H <-- Example "3" (right+, front-)
       ...
       O-- FRONT --+
*/
#define NOZZLE_TO_PROBE_OFFSET { 10 , -60  , -2.50}

//#define NOZZLE_TO_PROBE_OFFSET { -20 , -51  , -3.60 }
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 190 //(-X_MIN_POS+X_BED_SIZE)
#define Y_MAX_POS 190 //(-Y_MIN_POS+Y_BED_SIZE)
...
#define XY_DIAG_AC 283.12
#define XY_DIAG_BD 287.5
#define XY_SIDE_AD 209.82
...
#define XZ_DIAG_AC 284.14
#define XZ_DIAG_BD 284.14
#define YZ_DIAG_AC 279.76
#define YZ_DIAG_BD 281.94
#define YZ_SIDE_AD 199.36
